...
export const FourTet = (found:boolean, queryCode:string) => {
    ...
    <!--<div id="loading" style="position:absolute;left:20%;top:30%;font-size:50px;"> LOADING...</div>-->
      ...
      <g>
          ...
          <g>
              <path fill="#8AFFCA" d="M172.3,323.3v16.4h-22.7v-27h19.4v10.6H172.3z M156.1,323.3h6.4V319h-6.4V323.3z M156.1,333.5h9.6v-4.6
                  h-9.6V333.5z"/>
    ...
    <script>
        ...
        // init renderer
        function AR(){
            setTimeout(()=>AEContainer.remove(), 5000)
            console.log('hey')
